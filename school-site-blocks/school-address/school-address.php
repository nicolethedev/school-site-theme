 ...
 * Text Domain:       school-address
 *
 * @package SchoolSiteBlocks
 */
 ...
 */
function school_site_blocks_school_address_block_init() {
...
add_action( 'init', 'school_site_blocks_school_address_block_init' );
